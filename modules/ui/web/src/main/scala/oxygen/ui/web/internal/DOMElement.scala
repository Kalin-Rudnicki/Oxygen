...
object DOMElement {
  ...
  sealed trait WithTagAndChildren extends Entity {
    ...
    private final lazy val cssAttrMap: Map[String, String] = attrChildren.iterator.collect { case DOMElement.CSSAttr(k, v) => (k, v.value) }.toMap.filterNot(_._2 == removeInlineValue)
