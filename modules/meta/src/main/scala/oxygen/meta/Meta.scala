...
final class Meta[Q <: Quotes](val quotes: Q) {
  ...
  object Tree {
    ...
    object Statement {
      ...
      object Definition {
        ...
        final case class DefDef(raw: Raw.DefDef) extends Definition
        object DefDef {
        ...
        final case class ValDef(raw: Raw.ValDef) extends Definition
        object ValDef {
  ...
  object TypeRepr {
    ...
    def fromType(tpe: Type[?]): TypeRepr =
      TypeRepr.of[Any](using tpe.asInstanceOf[Type[Any]])
  ...
  object unapplies {
    ...
    object sealedTraitOrAbstractClass {
